...
This repository contains the source code of OFT Adapter for GLM. The initial token contract was deployed on Ethereum, with LayerZero-powered OFTs on other networks.
