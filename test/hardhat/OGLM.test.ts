...
describe('OGLM Test', function () {
    // Constant representing a mock Endpoint ID for testing purposes
    const eidA = 1
    const eidB = 2
    // Declaration of variables to be used in the test suite
    let OGLM: ContractFactory
    ...
    before(async function () {
        ...
        OGLM = await ethers.getContractFactory('OGLMMock')
    ...
    beforeEach(async function () {
        ...
        // Deploying two instances of OGLM contract with different identifiers and linking them to the mock LZEndpoint
        myOFTA = await OGLM.deploy('aOFT', 'aOFT', mockEndpointV2A.address, ownerA.address)
        myOFTB = await OGLM.deploy('bOFT', 'bOFT', mockEndpointV2B.address, ownerB.address)

        // Setting destination endpoints in the LZEndpoint mock for each OGLM instance
        ...
        // Setting each OGLM instance as a peer of the other in the mock LZEndpoint
